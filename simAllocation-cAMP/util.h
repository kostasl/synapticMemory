...
template <class T>
void makeLogFileNames(vector<string>& vLogFiles,unsigned int ciInitPeriod,int iCascadeSize,double mdRate,double dSignalThres,uint trials, int iSynCount)
{
	if (vLogFiles.empty())
...
template <class T>
void makeLogFileNames(vector<string>& vLogFiles,unsigned int ciInitPeriod,int FilterState,int iCascadeSize,double mdRate,double dSignalThres,uint trials, int iSynCount)
{
	makeLogFileNames<T>(vLogFiles,ciInitPeriod,iCascadeSize,mdRate,dSignalThres,trials, iSynCount);
