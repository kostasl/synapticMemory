...
PoissonSource::PoissonSource()
{
	...
	h		= 1.0;
	sigma	= 0.0;
	mlamdaInTs = 0;//round(mlamda/h); ////The rate of Events in number of timesteps - The number of timesteps in the Event rate
	rng_r = 0;//g_getRandGeneratorInstance(false);
}
