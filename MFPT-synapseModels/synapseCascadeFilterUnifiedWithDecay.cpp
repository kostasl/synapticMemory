...
const double synapseCascadeFilterUnifiedWithDecay::mdPDF_r100[][7] = {
...
//N=15 Double Decay Filter
 const int8_t synapseCascadeFilterUnifiedWithDecay::miThreshold_r100[][2] ={ {1,1},{1,2},
												{2,2},{2,2},
												{4,4},{4,4}, //n=6
												{4,4},{4,4},
												{4,4},{4,4}, //n=10
 ...
 const int8_t synapseCascadeFilterUnifiedWithDecay::miThresholdTerminal_r100[][2] ={ {1,1},{1,1},
 												{2,1},{4,1}, //n=3
 												{3,2},{3,2}, //n=5
 												{3,2},{4,3}, //n=7
 												{4,3},{4,3}, //n=9
 ...
 const double synapseCascadeFilterUnifiedWithDecay::mdDecayTerminal_r100[][2] ={ {0.0,0.0},{0.0,0.0},//n=2
 												...
 												{2.539424,2.539424} }; //nReflecting Boundary Values
...
///Matched Escape times to 1/q+p
//N=15 Double Decay Filter
const int8_t synapseCascadeFilterUnifiedWithDecay::miThreshold_r001[][2] ={  {1,1},{2,1}, //n=2
															{2,2},{2,2}, //n=4
															{2,2},{2,2}, //n=6
															{2,2},{2,2}, //n=8
															{3,3},{4,4}, //n=10
