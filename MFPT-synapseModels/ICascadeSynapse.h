...
typedef const int (*PtrThresholdSet)[15][2];
typedef const int8_t (*PtrThresholdSetSmall)[15][2];

typedef const double (*PtrDecaySet)[15][2];
typedef const double (*PtrPDFSet)[15][2];
