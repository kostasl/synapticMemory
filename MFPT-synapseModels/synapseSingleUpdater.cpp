...
synapseSingleUpdater::synapseSingleUpdater(int piCascadeSize,int piStartIndex,SYN_STRENGTH_STATE penumStrength,gsl_rng * rng_r)
{
...
int8_t synapseSingleUpdater::handlePOT()
{
    ...
    { //Already in STRONG  - Do Nothing
    	if (menumStrength_State != SYN_STRENGTH_STRONG)
    		liberrexit(666,"Error:Updater Synapse not in STRONG state as expected!");
